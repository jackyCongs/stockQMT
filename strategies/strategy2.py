...
class Strategy2:
    def __init__(self, db, trader_service):
        ...
        # 单个股票最大可以持仓多少钱
        self.max_single_amount = 10000
        # 每次出价最低多少钱
        self.min_bid_amount = 500
    ...
    def run(self):
        ...
        for index_code in self.target_index_infos:
            ...
            print(f"subscribe successful: {subscribe_id}, {index_code}")
    ...
    def handler(self, msgs):
        ...
        print(f'{datetime.datetime.now()} 函数运行耗时 {(time.perf_counter() - t0) * 1000:.3f} ms')
